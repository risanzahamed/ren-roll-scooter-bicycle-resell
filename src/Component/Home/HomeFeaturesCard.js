            ...
            <section class="py-10 lg:max-w-[1500px]  mx-auto  sm:py-16 lg:py-24">
                <div>
                    <div class="grid grid-cols-1 gap-12 text-center sm:grid-cols-2 md:grid-cols-3 ">
                        <div className='border bg-white  rounded-md p-8 m-4 lg:m-0 lg:p-14 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300 hover:text-white transition ease-in-out delay-150'>
                        ...
                        <div className='border bg-white hover:text-white rounded-md p-8 m-4 lg:m-0 lg:p-14 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300 transition ease-in-out delay-150'>
                        ...
                        <div className='border bg-white rounded-md lg:w-[550px] p-4 m-4  lg:m-0 lg:p-8 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300 hover:text-white transition ease-in-out delay-150'>
