...
const AddProduct = () => {
    ...
    const imageHostKey = "89ee26d6c8adb650e280f98a3d4176ca"
        ...
        <form onSubmit={handleSubmit(handleAddProduct)}>
            <div className="max-w-md w-full mt-14 bg-white shadow rounded-lg p-7 space-y-6">
                ...
                <div className="flex flex-col">
                    ...
                    <input {...register("email")} className="border rounded-md  bg-white px-3 py-2" defaultValue={email} type="email" id="text" required />
                </div>
                <div className="flex flex-col">
